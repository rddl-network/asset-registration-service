...
3. sudo cp asset_registry.service /lib/systemd/system/
4. sudo systemctl start asset_registry.service 
5. sudo systemctl status asset_registry.service 
6. sudo journalctl -u asset_registry.service
